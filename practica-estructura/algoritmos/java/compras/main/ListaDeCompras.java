package compras.main;

import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;
import static compras.main.ListaDeCompras.Opcion.*;
...
public class ListaDeCompras {
	...
	*/
	public static void main(String[] args) {
		Lista listaSuper = new <String> Elistas();
		bienvenida();
		try {
			...
			do {
				...
				salir = responderAEntrada(entrada,listaSuper);
			} while (!salir);
	...
	private static boolean responderAEntrada(String entrada, Lista listaSuperMercado) {
		...
		if (comando.compareToIgnoreCase(AGREGAR.opcion()) == 0) {
			...
			agregarElemento(listaSuperMercado, producto);
			//System.out.println("Producto ingresado: " + producto);
			//System.out.println("Resultado de la agregacion: " + ListaSuper.agregar(producto));
			//System.out.println("Cantidad de elementos: " + ListaSuper.elementos());
			//TODO: agregar el producto a la lista de productos.
			return false;
		} else if (comando.compareToIgnoreCase(LISTAR.opcion()) == 0) {
			//System.out.println("Cantidad de elementos: " + ListaSuper.elementos());
			mostrarElemento(listaSuperMercado);	
	...
	private static void agregarElemento(Lista lista, String elem){
		lista.agregar(elem);
	}

	private static void mostrarElemento(Lista lista){
